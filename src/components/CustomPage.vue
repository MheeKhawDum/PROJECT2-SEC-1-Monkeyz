...
const questions = ref([
  { id: 1, question: "เลือกประเภทเครื่องดื่ม", key: 'temp', options: ["ร้อน", "เย็น"] },
  { id: 2, question: "เลือก Bottoming", key: 'bottoming', options: ["ไข่มุกดำ", "ถั่วแดง", "คอนยัค"] },
  { id: 3, question: "เลือก Base", key: 'base', options: ["ชานม", "ชาเขียว", "โกโก้"] },
  { id: 4, question: "เลือก Flavor", key: 'flavor', options: ["ช็อคโกแลต", "นม", "สตอเบอร์รี่"] },
  { id: 5, question: "เลือก Topping", key: 'topping', options: ["ไข่มุก", "เยลลี่", "วิปครีม"] },
]);
